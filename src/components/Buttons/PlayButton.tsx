...
const PlayButton = ({ movieId }: PlayButtonProps) => {
  ...
  return (
    <button
      className='bg-primary rounded-md py-2 px-8 text-xs lg:text-lg font-semibold flex flex-row items-center justify-center hover:bg-opacity-80 transition duration lg:w-[150px]'
      onClick={() => {
        onClose();
